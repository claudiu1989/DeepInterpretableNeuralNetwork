...
def experiment_running_time_vs_number_of_features():
    ...
    for n_features in n_features_values:
        ...
        # Evaluation
        _, avg_training_time, var_training_time, avg_test_time, var_test_time = EvaluationTools.evaluate_multiple_times(dipnn, X, Y, no_runs, test_size, coefficient_threshold, precision)
